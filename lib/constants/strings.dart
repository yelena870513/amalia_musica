class Strings {
  ...
  //General
  static const String appName = "Amalia Simoni";
...
Su temática es novedosa, ya que está compuesta por un joven valor, quien combina los hechos reales de la vida, en este caso de una patriota artista y de sensibilidad exquisita, con el lenguaje de la música que narra su historia.

La obra refleja el momento decisivo de la valiente Amalia, de irse a la manigua con su esposo Ignacio y todo lo que eso conllevó para su vida, hasta el trágico desenlace: la caída en combate de El Mayor.

Está dirigida a músicos, estudiantes de música y público en general, amantes de este arte y de la historia.

Sirva esta modesta obra como profundo homenaje al amor que los unió y que rompió las barreras del tiempo.
''';
}
